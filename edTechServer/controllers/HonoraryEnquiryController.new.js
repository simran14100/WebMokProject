...
const getHonoraryEnquiries = async (req, res) => {
    try {
...
const getHonoraryEnquiryById = async (req, res) => {
    try {
...
const createHonoraryEnquiry = async (req, res) => {
    try {
...
const updateHonoraryEnquiry = async (req, res) => {
    try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
            return res.status(400).json({
...
const deleteHonoraryEnquiry = async (req, res) => {
    try {
