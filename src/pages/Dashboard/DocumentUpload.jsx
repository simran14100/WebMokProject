...
//     <div className="bg-richblack-800 p-6 rounded-lg shadow-md h-fit">
//       <h2 className="text-xl font-semibold text-richblack-5 mb-4">Instructions</h2>
//       <ul className="list-disc list-inside space-y-3 text-sm text-richblack-200">
//         <li>Upload <span className="font-medium text-yellow-50">Aadhaar Card</span> (file name: <code className="text-yellow-100">aadhaar</code>).</li>
//         <li>Upload <span className="font-medium text-yellow-50">Secondary Marksheet</span> (file name: <code className="text-yellow-100">secondary</code>).</li>
//         <li>Upload <span className="font-medium text-yellow-50">Senior Secondary Marksheet</span> (file name: <code className="text-yellow-100">seniorsecondary</code>).</li>
//         <li>If graduated, upload <span className="font-medium text-yellow-50">Graduation Marksheet</span> (file name: <code className="text-yellow-100">graduation</code>).</li>
//         <li>If post-graduated, upload <span className="font-medium text-yellow-50">Post Graduation Marksheet</span> (file name: <code className="text-yellow-100">postgraduation</code>).</li>
//       </ul>
//       <p className="mt-4 text-xs text-richblack-400">
//         ⚠️ Ensure files are named correctly before uploading. Incorrect file names may delay verification.
//       </p>
//     </div>
//   </div>
