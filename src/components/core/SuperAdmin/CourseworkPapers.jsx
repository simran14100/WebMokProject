            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Theory (MM) ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Theory (MPM) ↑↓</th>
                </tr>
              </thead>
              <tbody>
                {items.length === 0 ? (
