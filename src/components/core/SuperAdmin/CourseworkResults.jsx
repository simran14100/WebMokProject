            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Student ID ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Student Name ↑↓</th>
                  ...
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Theory ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>IA ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Total ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Result ↑↓</th>
                  <th style={{ background: '#0f172a', color: '#fff', padding: '10px', textAlign: 'left' }}>Grade ↑↓</th>
                </tr>
              </thead>
              <tbody>
                {items.length === 0 ? (
