...
export default function CourseBuilderForm() {
  ...
  return (
    <div className="space-y-8 p-8 bg-white rounded-md border border-gray-200 shadow-md max-w-2xl mx-auto">
      <p className="text-2xl font-semibold text-green-700">Course Builder</p>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="flex flex-col space-y-2">
          <label className="text-sm font-semibold text-green-700" htmlFor="sectionName">
        ...
        <div className="flex items-end gap-x-4">
          <IconBtn
            ...
            outline={true}
          >
            <IoAddCircleOutline size={20} className="text-green-700" />
          </IconBtn>
          {editSectionName && (
            <button
              type="button"
