import { useState } from "react";
  ...
  // Update your imports to use available icons
import {
  VscDashboard,
  VscFiles,
  VscOrganization,
  VscGift,
  VscAccount,      // For person/user related icons
  VscGear,        // For settings/management
  VscListTree,    // For categories
  VscListFlat,    // For sub-categories
  VscVersions,    // For batches
  VscChevronRight,
  VscSignOut,
  VscChecklist    // For student management
    ...
    return [
      ...
      },
      {
        ...
        subLinks: [
          ...
          { name: "All Sub Categories", path: "/admin/subcategories" }
        ]
      },
      {
        name: "Course", 
